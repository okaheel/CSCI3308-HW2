...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = (letter.classList.value.includes("invalid") || capital.classList.value.includes("invalid") || number.classList.value.includes("invalid") || length.classList.value.includes("invalid") || match.classList.value.includes("invalid"));
    if (condition) {
